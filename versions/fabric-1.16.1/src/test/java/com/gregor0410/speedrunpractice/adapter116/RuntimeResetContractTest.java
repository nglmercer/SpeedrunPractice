...
/**
 * Real-runtime reset ladder for 1.16.1 (no Minecraft needed): start on
...
public class RuntimeResetContractTest {
    ...
    public void resetLadderRecyclesWorldsWithoutLeaks() throws Exception {
        ScenarioTestHarness harness = new ScenarioTestHarness(GameVersion.MC_1_16_1);
        ...
        assertEquals(GameVersion.MC_1_16_1, runtime.adapter().version());
        runtime.stop();
