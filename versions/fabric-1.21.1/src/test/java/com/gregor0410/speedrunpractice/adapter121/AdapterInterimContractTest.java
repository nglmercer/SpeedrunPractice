...
/**
 * Locks the delegation contracts of the 1.21.1 shell: construction requires
...
public class AdapterInterimContractTest {
    ...
    public void versionIs121() {
        assertEquals(GameVersion.MC_1_21_1, new AdapterSet121(new FakeMinecraftAdapter()).version());
    }
