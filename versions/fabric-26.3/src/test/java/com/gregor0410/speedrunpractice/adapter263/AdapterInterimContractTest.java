...
/**
 * Locks the delegation contracts of the 26.3 shell: construction requires
 ...
 * their interim contracts until the real ports land.
 */
public class AdapterInterimContractTest {
    ...
    public void versionIs263() {
        assertEquals(GameVersion.V_26_3, new AdapterSet263(new FakeMinecraftAdapter()).version());
    }
    ...
    public void analyzerMatchesOnlyUnconstrainedQueries() {
        Seeds263 analyzer = new Seeds263();
