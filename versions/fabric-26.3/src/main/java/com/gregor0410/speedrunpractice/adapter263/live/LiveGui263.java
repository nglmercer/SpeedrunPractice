...
import com.gregor0410.speedrunpractice.adapter263.client.ClientScreens263;
...
final class LiveGui263 implements GuiAdapter {
    ...
    private void openClient(Runnable opener) throws PracticeException {
        ...
        ClientScreens263.openOnClientThread(opener);
    }
    ...
    private static final class OpenScenario implements Runnable {
        ...
        @Override
        public void run() {
            ClientScreens263.openSetup(preset, customId);
        }
    }
